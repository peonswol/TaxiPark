...
import com.taxipark.component.action.DeleteCar;
import com.taxipark.component.action.EditCarData;
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        ...
        try {
            ...
            if (cars.size() == 0) {
                ...
                enteringEngineCapacityCar.setValueFactory(new SpinnerValueFactory.DoubleSpinnerValueFactory(1, 6, 1, 0.1));
        ...
        try {
            if (selectListCar.getValue() != null) {
                ...
                if (carSelectedByID != null) {
                    ...
                    setAlert(Alert.AlertType.INFORMATION, "Авто успішно видалено!", "");

                }else {
                    setAlert(Alert.AlertType.ERROR, "Виникла помилка із видаленням!", "Спробуйте ще раз, перевіривши коректність запитів.");
